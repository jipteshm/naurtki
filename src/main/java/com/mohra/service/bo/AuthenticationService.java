...
import com.mohra.common.Utils;
import com.mohra.common.staticdata.TokenType;
import com.mohra.dto.AuthenticationResponseInfo;
import com.mohra.dto.GrandAuthorityRoleInfo;
import com.mohra.entity.JwtToken;
import com.mohra.mapper.JwtResponseMapper;
import com.mohra.repository.JwtTokenRepository;
...
public class AuthenticationService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String emailId) throws UsernameNotFoundException {
        com.mohra.entity.User user = userRepository.findByEmailId(emailId);
